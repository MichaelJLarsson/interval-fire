...
export function totalSecs(
  preset: Pick<Preset, 'workSecs' | 'restSecs' | 'rounds' | 'warmupSecs' | 'cooldownSecs'>,
): number {
  return (
    preset.rounds * (preset.workSecs + preset.restSecs) + preset.warmupSecs + preset.cooldownSecs
  )
}
