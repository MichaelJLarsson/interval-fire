...
- Portrait orientation only, except the Timer and Complete screens, which allow free rotation into landscape (`useOrientationLock`); every other screen re-locks to portrait on entry/exit.
